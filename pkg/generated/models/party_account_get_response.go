...
// PartyAccountGetResponse party account get response
// swagger:model PartyAccountGetResponse
...
func PartyAccountGetResponseWithDefaults(defaults client.Defaults) *PartyAccountGetResponse {
	return &PartyAccountGetResponse{
...
func (m *PartyAccountGetResponse) validateData(formats strfmt.Registry) error {
...
func (m *PartyAccountGetResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *PartyAccountGetResponse) UnmarshalBinary(b []byte) error {
	var res PartyAccountGetResponse
