...
// DirectDebitReturnSubmissionCreation direct debit return submission creation
// swagger:model DirectDebitReturnSubmissionCreation
...
func DirectDebitReturnSubmissionCreationWithDefaults(defaults client.Defaults) *DirectDebitReturnSubmissionCreation {
	return &DirectDebitReturnSubmissionCreation{
...
func (m *DirectDebitReturnSubmissionCreation) validateData(formats strfmt.Registry) error {
...
func (m *DirectDebitReturnSubmissionCreation) UnmarshalBinary(b []byte) error {
	var res DirectDebitReturnSubmissionCreation
