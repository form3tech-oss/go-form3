...
type ReversalAdmissionTaskAttributes struct {
	...
	// name
	Name ReversalAdmissionTaskName `json:"name,omitempty"`
...
func ReversalAdmissionTaskAttributesWithDefaults(defaults client.Defaults) *ReversalAdmissionTaskAttributes {
	return &ReversalAdmissionTaskAttributes{
		...
		// TODO Name: ReversalAdmissionTaskName,
...
func (m *ReversalAdmissionTaskAttributes) WithName(name ReversalAdmissionTaskName) *ReversalAdmissionTaskAttributes {
...
func (m *ReversalAdmissionTaskAttributes) validateName(formats strfmt.Registry) error {
