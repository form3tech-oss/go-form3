...
const (
	...
	// ResourceTypeQualifiedTransactions captures enum value "qualified_transactions"
	ResourceTypeQualifiedTransactions ResourceType = "qualified_transactions"
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["accounts","account_identifications","branch_identifications","bics","bank_ids","account_configurations","account_routings","account_events","direct_account","account_indirects","branches","payment_admissions","payment_batches","payment_submissions","payment_submission_validations","payments","return_admissions","return_admission_tasks","return_reversals","return_reversal_admissions","return_submissions","return_submission_validations","return_submission_tasks","returns","reversal_admissions","reversal_admission_tasks","reversal_submissions","reversal_submission_validations","reversals","limits","positions","payment_defaults","qualified_transactions","recalls","recall_submissions","recall_admissions","recall_decisions","recall_decision_admissions","recall_decision_admission_tasks","recall_decision_submissions","recall_decision_submission_tasks","recall_submission_validations","recall_admission_tasks","recall_submission_tasks","recall_decision_submission_validations","recall_reversals","recall_reversal_admissions","auto_recall_decision_submissions","on_us_routes","routes","gateway_associations","customer_configurations","xp_agreements","xp_configurations","payment_advices","payment_advice_submissions","payment_advice_submission_validations","payment_automatic_returns","fx_deals","parties","contact_accounts","party_accounts","contacts","payment_admission_tasks","payment_submission_tasks","reports","report_admissions","report_requests","report_request_submissions","scheme_messages","scheme_message_admissions","subscriptions","keys","certificates","transaction_files","transaction_file_submissions","transaction_file_admissions","scheme_files","scheme_file_submissions","scheme_file_admissions","days"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
