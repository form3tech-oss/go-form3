...
func (o *PostDirectdebitsIDReversalsReversalIDSubmissionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		result := NewPostDirectdebitsIDReversalsReversalIDSubmissionsNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPostDirectdebitsIDReversalsReversalIDSubmissionsNotFound creates a PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound with default headers values
func NewPostDirectdebitsIDReversalsReversalIDSubmissionsNotFound() *PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound {
	return &PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound{}
}

/*
PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound handles this case with default header values.

Not found error
*/
type PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound struct {
...
// IsSuccess returns true when this post directdebits Id reversals reversal Id submissions not found response has a 2xx status code
func (o *PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post directdebits Id reversals reversal Id submissions not found response has a 3xx status code
func (o *PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post directdebits Id reversals reversal Id submissions not found response has a 4xx status code
func (o *PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this post directdebits Id reversals reversal Id submissions not found response has a 5xx status code
func (o *PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this post directdebits Id reversals reversal Id submissions not found response a status code equal to that given
func (o *PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound) IsCode(code int) bool {
	return code == 404
}

// Code gets the status code for the post directdebits Id reversals reversal Id submissions not found response
func (o *PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound) Code() int {
	return 404
}

func (o *PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound) Error() string {
	return fmt.Sprintf("[POST /transaction/directdebits/{id}/reversals/{reversalId}/submissions][%d] postDirectdebitsIdReversalsReversalIdSubmissionsNotFound", 404)
}

func (o *PostDirectdebitsIDReversalsReversalIDSubmissionsNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
