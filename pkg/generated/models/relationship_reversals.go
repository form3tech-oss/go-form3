...
// RelationshipReversals relationship reversals
// swagger:model RelationshipReversals
...
func (m *RelationshipReversals) validateData(formats strfmt.Registry) error {
