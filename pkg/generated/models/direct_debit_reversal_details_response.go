...
// DirectDebitReversalDetailsResponse direct debit reversal details response
// swagger:model DirectDebitReversalDetailsResponse
...
func DirectDebitReversalDetailsResponseWithDefaults(defaults client.Defaults) *DirectDebitReversalDetailsResponse {
	return &DirectDebitReversalDetailsResponse{
...
func (m *DirectDebitReversalDetailsResponse) validateData(formats strfmt.Registry) error {
...
func (m *DirectDebitReversalDetailsResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *DirectDebitReversalDetailsResponse) UnmarshalBinary(b []byte) error {
	var res DirectDebitReversalDetailsResponse
