...
// BranchIdentificationData branch identification data
// swagger:model BranchIdentificationData
...
func BranchIdentificationDataWithDefaults(defaults client.Defaults) *BranchIdentificationData {
	return &BranchIdentificationData{}
}
...
func (m *BranchIdentificationData) validateRelationships(formats strfmt.Registry) error {
...
func (m *BranchIdentificationData) UnmarshalBinary(b []byte) error {
	var res BranchIdentificationData
