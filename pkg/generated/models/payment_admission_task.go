...
type PaymentAdmissionTaskAttributes struct {
	...
	// assignee
	Assignee PaymentTaskAssignee `json:"assignee,omitempty"`
...
func PaymentAdmissionTaskAttributesWithDefaults(defaults client.Defaults) *PaymentAdmissionTaskAttributes {
	return &PaymentAdmissionTaskAttributes{
		...
		// TODO Assignee: PaymentTaskAssignee,

		Name: defaults.GetString("PaymentAdmissionTaskAttributes", "name"),
...
func (m *PaymentAdmissionTaskAttributes) WithAssignee(assignee PaymentTaskAssignee) *PaymentAdmissionTaskAttributes {
...
func (m *PaymentAdmissionTaskAttributes) WithName(name string) *PaymentAdmissionTaskAttributes {
...
var paymentAdmissionTaskAttributesTypeNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		paymentAdmissionTaskAttributesTypeNamePropEnum = append(paymentAdmissionTaskAttributesTypeNamePropEnum, v)
	}
}

const (

	// PaymentAdmissionTaskAttributesNameCustomerChecks captures enum value "customer_checks"
	PaymentAdmissionTaskAttributesNameCustomerChecks string = "customer_checks"

	// PaymentAdmissionTaskAttributesNameAccountCheck captures enum value "account_check"
	PaymentAdmissionTaskAttributesNameAccountCheck string = "account_check"

	// PaymentAdmissionTaskAttributesNameConfirmToScheme captures enum value "confirm_to_scheme"
	PaymentAdmissionTaskAttributesNameConfirmToScheme string = "confirm_to_scheme"

	// PaymentAdmissionTaskAttributesNameRejectToScheme captures enum value "reject_to_scheme"
	PaymentAdmissionTaskAttributesNameRejectToScheme string = "reject_to_scheme"
)

// prop value enum
func (m *PaymentAdmissionTaskAttributes) validateNameEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, paymentAdmissionTaskAttributesTypeNamePropEnum); err != nil {
		return err
	}
	return nil
}
