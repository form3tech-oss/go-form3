...
// AdviceDetailsResponse advice details response
// swagger:model AdviceDetailsResponse
...
func (m *AdviceDetailsResponse) validateData(formats strfmt.Registry) error {
...
func (m *AdviceDetailsResponse) validateLinks(formats strfmt.Registry) error {
