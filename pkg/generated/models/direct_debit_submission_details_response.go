...
// DirectDebitSubmissionDetailsResponse direct debit submission details response
// swagger:model DirectDebitSubmissionDetailsResponse
...
func DirectDebitSubmissionDetailsResponseWithDefaults(defaults client.Defaults) *DirectDebitSubmissionDetailsResponse {
	return &DirectDebitSubmissionDetailsResponse{
...
func (m *DirectDebitSubmissionDetailsResponse) validateData(formats strfmt.Registry) error {
...
func (m *DirectDebitSubmissionDetailsResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *DirectDebitSubmissionDetailsResponse) UnmarshalBinary(b []byte) error {
	var res DirectDebitSubmissionDetailsResponse
