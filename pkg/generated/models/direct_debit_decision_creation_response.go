...
// DirectDebitDecisionCreationResponse direct debit decision creation response
// swagger:model DirectDebitDecisionCreationResponse
...
func DirectDebitDecisionCreationResponseWithDefaults(defaults client.Defaults) *DirectDebitDecisionCreationResponse {
	return &DirectDebitDecisionCreationResponse{
...
func (m *DirectDebitDecisionCreationResponse) validateData(formats strfmt.Registry) error {
...
func (m *DirectDebitDecisionCreationResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *DirectDebitDecisionCreationResponse) UnmarshalBinary(b []byte) error {
	var res DirectDebitDecisionCreationResponse
