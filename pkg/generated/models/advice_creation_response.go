...
// AdviceCreationResponse advice creation response
// swagger:model AdviceCreationResponse
...
func (m *AdviceCreationResponse) validateData(formats strfmt.Registry) error {
...
func (m *AdviceCreationResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *AdviceCreationResponse) UnmarshalBinary(b []byte) error {
	var res AdviceCreationResponse
