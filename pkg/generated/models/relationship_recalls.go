...
// RelationshipRecalls relationship recalls
// swagger:model RelationshipRecalls
...
func (m *RelationshipRecalls) validateData(formats strfmt.Registry) error {
