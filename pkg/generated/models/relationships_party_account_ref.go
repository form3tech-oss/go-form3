...
// RelationshipsPartyAccountRef relationships party account ref
// swagger:model RelationshipsPartyAccountRef
...
func RelationshipsPartyAccountRefWithDefaults(defaults client.Defaults) *RelationshipsPartyAccountRef {
	return &RelationshipsPartyAccountRef{

		Data: make([]*RelationshipsPartyAccountRefData, 0),
	}
}
...
func (m *RelationshipsPartyAccountRef) validateData(formats strfmt.Registry) error {
...
func (m *RelationshipsPartyAccountRef) UnmarshalBinary(b []byte) error {
	var res RelationshipsPartyAccountRef
