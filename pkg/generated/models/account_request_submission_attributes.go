...
type AccountRequestSubmissionAttributes struct {
	...
	// status
	Status AccountRequestSubmissionStatus `json:"status,omitempty"`
...
func AccountRequestSubmissionAttributesWithDefaults(defaults client.Defaults) *AccountRequestSubmissionAttributes {
	return &AccountRequestSubmissionAttributes{
		...
		// TODO Status: AccountRequestSubmissionStatus,
...
func (m *AccountRequestSubmissionAttributes) WithStatus(status AccountRequestSubmissionStatus) *AccountRequestSubmissionAttributes {
