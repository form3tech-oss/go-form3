...
func (m *SubscriptionDetailsResponse) validateData(formats strfmt.Registry) error {
...
func (m *SubscriptionDetailsResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *SubscriptionDetailsResponse) UnmarshalBinary(b []byte) error {
	var res SubscriptionDetailsResponse
