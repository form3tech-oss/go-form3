...
// PartyActorUpdatedEvent party actor updated event
// swagger:model PartyActorUpdatedEvent
...
func (m *PartyActorUpdatedEvent) validateData(formats strfmt.Registry) error {
...
func (m *PartyActorUpdatedEvent) UnmarshalBinary(b []byte) error {
	var res PartyActorUpdatedEvent
