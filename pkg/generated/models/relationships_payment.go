...
// RelationshipsPayment relationships payment
// swagger:model RelationshipsPayment
...
func RelationshipsPaymentWithDefaults(defaults client.Defaults) *RelationshipsPayment {
	return &RelationshipsPayment{
		...
		Data: make([]*RelationshipsPaymentProperties, 0),
	}
}
...
func (m *RelationshipsPayment) validateData(formats strfmt.Registry) error {
