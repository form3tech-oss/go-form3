...
func SendersCorrespondentAccountHoldingEntityWithDefaults(defaults client.Defaults) *SendersCorrespondentAccountHoldingEntity {
	return &SendersCorrespondentAccountHoldingEntity{
		...
		BankIDCode: defaults.GetString("SendersCorrespondentAccountHoldingEntity", "bank_id_code"),
...
func (m *SendersCorrespondentAccountHoldingEntity) WithBankIDCode(bankIDCode string) *SendersCorrespondentAccountHoldingEntity {
