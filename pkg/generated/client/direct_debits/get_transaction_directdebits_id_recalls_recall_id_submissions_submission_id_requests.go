...
func (o *GetTransactionDirectdebitsIDRecallsRecallIDSubmissionsSubmissionIDRequest) FromJson(j string) (*GetTransactionDirectdebitsIDRecallsRecallIDSubmissionsSubmissionIDRequest, error) {
