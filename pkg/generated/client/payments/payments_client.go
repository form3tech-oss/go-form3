...
*/
func (a *PatchTransactionPaymentsIDAdmissionsAdmissionIDTasksTaskIDRequest) Do() (*PatchTransactionPaymentsIDAdmissionsAdmissionIDTasksTaskIDCreated, error) {
	...
	return result.(*PatchTransactionPaymentsIDAdmissionsAdmissionIDTasksTaskIDCreated), nil

}

func (a *PatchTransactionPaymentsIDAdmissionsAdmissionIDTasksTaskIDRequest) MustDo() *PatchTransactionPaymentsIDAdmissionsAdmissionIDTasksTaskIDCreated {
	r0, err := a.Do()
	if err != nil {
		panic(err)
	}
