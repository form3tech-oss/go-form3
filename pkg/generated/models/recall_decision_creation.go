...
// RecallDecisionCreation recall decision creation
// swagger:model RecallDecisionCreation
...
func (m *RecallDecisionCreation) validateData(formats strfmt.Registry) error {
...
func (m *RecallDecisionCreation) UnmarshalBinary(b []byte) error {
	var res RecallDecisionCreation
