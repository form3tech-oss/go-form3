...
// RelationshipsContactAccountRefData relationships contact account ref data
// swagger:model RelationshipsContactAccountRefData
...
func RelationshipsContactAccountRefDataWithDefaults(defaults client.Defaults) *RelationshipsContactAccountRefData {
	return &RelationshipsContactAccountRefData{

		ID: defaults.GetStrfmtUUIDPtr("RelationshipsContactAccountRefData", "id"),
...
func (m *RelationshipsContactAccountRefData) validateID(formats strfmt.Registry) error {
...
func (m *RelationshipsContactAccountRefData) UnmarshalBinary(b []byte) error {
	var res RelationshipsContactAccountRefData
