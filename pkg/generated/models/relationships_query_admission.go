...
// RelationshipsQueryAdmission relationships query admission
// swagger:model RelationshipsQueryAdmission
...
func (m *RelationshipsQueryAdmission) validateData(formats strfmt.Registry) error {
...
func (m *RelationshipsQueryAdmission) UnmarshalBinary(b []byte) error {
	var res RelationshipsQueryAdmission
