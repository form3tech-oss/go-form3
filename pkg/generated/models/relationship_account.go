...
// RelationshipAccount relationship account
// swagger:model RelationshipAccount
...
func (m *RelationshipAccount) validateData(formats strfmt.Registry) error {
