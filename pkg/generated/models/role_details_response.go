...
func (m *RoleDetailsResponse) validateData(formats strfmt.Registry) error {
...
func (m *RoleDetailsResponse) validateLinks(formats strfmt.Registry) error {
