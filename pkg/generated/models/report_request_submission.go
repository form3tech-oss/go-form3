...
func (m *ReportRequestSubmission) validateCreatedOn(formats strfmt.Registry) error {
	...
	if err := validate.Required("created_on", "body", strfmt.DateTime(m.CreatedOn)); err != nil {
		return err
	}
...
func (m *ReportRequestSubmission) validateModifiedOn(formats strfmt.Registry) error {
	...
	if err := validate.Required("modified_on", "body", strfmt.DateTime(m.ModifiedOn)); err != nil {
		return err
	}
