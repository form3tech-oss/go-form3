...
// AccountIdentificationData account identification data
...
func (m *AccountIdentificationData) validateRelationships(formats strfmt.Registry) error {
...
func (m *AccountIdentificationData) Json() string {
