...
// Client.GetOrganisationBranches creates a new GetOrganisationBranchesRequest object
// with the default values initialized.
func (c *Client) GetOrganisationBranches() *GetOrganisationBranchesRequest {
	var ()
	return &GetOrganisationBranchesRequest{
		...
		PageNumber: c.Defaults.GetStringPtr("GetOrganisationBranches", "page[number]"),

		PageSize: c.Defaults.GetInt64Ptr("GetOrganisationBranches", "page[size]"),
...
func (o *GetOrganisationBranchesRequest) FromJson(j string) (*GetOrganisationBranchesRequest, error) {
...
func (o *GetOrganisationBranchesRequest) WithoutFilterBankID() *GetOrganisationBranchesRequest {
...
func (o *GetOrganisationBranchesRequest) WithPageNumber(pageNumber string) *GetOrganisationBranchesRequest {
...
func (o *GetOrganisationBranchesRequest) WithoutPageNumber() *GetOrganisationBranchesRequest {
...
func (o *GetOrganisationBranchesRequest) WithPageSize(pageSize int64) *GetOrganisationBranchesRequest {
...
func (o *GetOrganisationBranchesRequest) WithoutPageSize() *GetOrganisationBranchesRequest {
...
func (o *GetOrganisationBranchesRequest) WithContext(ctx context.Context) *GetOrganisationBranchesRequest {
	o.Context = ctx
	return o
}

// WithHTTPClient adds the HTTPClient to the get organisation branches Request
func (o *GetOrganisationBranchesRequest) WithHTTPClient(client *http.Client) *GetOrganisationBranchesRequest {
	o.HTTPClient = client
	return o
}

// WriteToRequest writes these Request to a swagger request
func (o *GetOrganisationBranchesRequest) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
