...
// RelationshipsQueryAdmissionProperties relationships query admission properties
// swagger:model RelationshipsQueryAdmissionProperties
...
func RelationshipsQueryAdmissionPropertiesWithDefaults(defaults client.Defaults) *RelationshipsQueryAdmissionProperties {
	return &RelationshipsQueryAdmissionProperties{

		ID: defaults.GetStrfmtUUIDPtr("RelationshipsQueryAdmissionProperties", "id"),
...
func (m *RelationshipsQueryAdmissionProperties) validateID(formats strfmt.Registry) error {
...
func (m *RelationshipsQueryAdmissionProperties) UnmarshalBinary(b []byte) error {
	var res RelationshipsQueryAdmissionProperties
