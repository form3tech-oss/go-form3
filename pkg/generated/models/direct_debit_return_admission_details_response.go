...
// DirectDebitReturnAdmissionDetailsResponse direct debit return admission details response
// swagger:model DirectDebitReturnAdmissionDetailsResponse
...
func DirectDebitReturnAdmissionDetailsResponseWithDefaults(defaults client.Defaults) *DirectDebitReturnAdmissionDetailsResponse {
	return &DirectDebitReturnAdmissionDetailsResponse{

		Data: DirectDebitReturnAdmissionWithDefaults(defaults),
...
func (m *DirectDebitReturnAdmissionDetailsResponse) validateData(formats strfmt.Registry) error {
...
func (m *DirectDebitReturnAdmissionDetailsResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *DirectDebitReturnAdmissionDetailsResponse) UnmarshalBinary(b []byte) error {
	var res DirectDebitReturnAdmissionDetailsResponse
