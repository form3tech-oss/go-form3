...
// RelationshipsPartyRef relationships party ref
// swagger:model RelationshipsPartyRef
...
func RelationshipsPartyRefWithDefaults(defaults client.Defaults) *RelationshipsPartyRef {
	return &RelationshipsPartyRef{

		Data: make([]*RelationshipsPartyRefData, 0),
	}
}
...
func (m *RelationshipsPartyRef) validateData(formats strfmt.Registry) error {
