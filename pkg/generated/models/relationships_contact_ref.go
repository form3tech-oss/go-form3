...
// RelationshipsContactRef relationships contact ref
// swagger:model RelationshipsContactRef
...
func RelationshipsContactRefWithDefaults(defaults client.Defaults) *RelationshipsContactRef {
	return &RelationshipsContactRef{

		Data: make([]*RelationshipsContactRefData, 0),
	}
}
...
func (m *RelationshipsContactRef) validateData(formats strfmt.Registry) error {
...
func (m *RelationshipsContactRef) UnmarshalBinary(b []byte) error {
	var res RelationshipsContactRef
